...
class Player {
    ...
    public boolean addMoney(double moneyAdded){
        money = money +moneyAdded;
        return true;
    }
    public boolean removeMoney(double moneySubtracted){
        money = money - moneySubtracted;
        return true;
    }
    ...
    public void wear(Item item){
        if(wearing == false){
            wearing = true;
            System.out.println("Player put on the "+item +" is now wearing it");
        }
        equip( item);
    }
    ...
    public void consume(Item item){
        System.out.println("player consumed "+ item);
    }
    public void equip(Item item){
        System.out.println("Player equiped "+ item);
